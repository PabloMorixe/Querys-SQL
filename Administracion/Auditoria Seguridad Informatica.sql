--Obtiene el período con información de auditoría disponible en la tabla
SELECT MIN(StartTime) AS FECHA_MINIMA_AUDITADA, 
	   MAX(StartTime) AS FECHA_MAXIMA_AUDITADA
FROM TRACE..TRAZAS
